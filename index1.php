...
<head>
    ...
    <title>Rafi Telecom - Retailer Service of Rafi Telecom</title>
    <!-- font awesome file linked  -->
...
<body>
    <!-- Header area navnbar or menu bar  inside start-->
    <header id="header-section">
        <div class="wrapper">
            <div class="container">
                <!-- navbar and main menu area  -->
                    ...
                    <div class="menu-bar">
                        <nav id="main_menu">
                            ...
                            <div class="floating-btn-group">
                                <a href="javascript:void(0)" class="service-panel-btn"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                <div class="service-panel-area side-panel-modal">
                                        <div class="inner-header">
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <h5 class="text-center text-white">Recharge Panel</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="sidebar">
                    <div class="inner-header">
                        <div class="container">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="main-sidebar-close-btn close-btn">
                                        <a href="javascript:void(0)"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                <div class="col">
                    ...
                    <div class="inner-body">
                        <div class="top-bar">
                            <div class="profile">
                                <div class="owner-info row align-items-center py-2">
                                    <div class="col-auto">
                                        <div class="pic"><img src="assets/img/profile-pic.png" alt=""></div>
                                    </div>
                                    <div class="col-auto">
                                        ...
                                        <div class="name">Rafi Telecom</div>
                                        <div class="phone">+88 01684285963</div>
                                        <div class="owner-name">Owner Name: Md. Omar Faruk</div>

                                    </div>

                                </div>
                                <div class="dso-info row">
                                    <div class="col-auto">
                                        <div class="dso-name"> DSO Name: Md. Omar Faruk</div>
                                        <div class="dso-phone">DSO Phone: <a href="tel:+8801684285963"><i class="fa fa-phone" aria-hidden="true"></i> +8801684285963</a></div>
                                    </div>
                                </div>
